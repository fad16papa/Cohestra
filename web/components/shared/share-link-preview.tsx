...
export function ShareLinkPreview({
  preview,
  sampleMessage = "Check this out!",
  helperText = "Approximate preview when you share this link in WhatsApp, Telegram, or iMessage.",
}: ShareLinkPreviewProps) {
  const hostname = hostnameFromUrl(preview.url);

  return (
    <div className="space-y-2">
      <p className="text-sm font-medium text-text-warm">Link preview</p>
