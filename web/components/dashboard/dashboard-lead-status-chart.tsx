          ...
          <ul className="shrink-0 divide-y divide-border-warm/70 border-t border-border-warm/70">
            {slices.map((slice) => (
              <li key={slice.key}>
                <Link
                  href={slice.href}
                  className="group flex items-center gap-3 px-4 py-2.5 motion-press hover:bg-muted/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring sm:px-5"
          ...
          <ul className="w-full space-y-2">
            {slices.map((slice) => (
              <li key={slice.key}>
                <Link
                  href={slice.href}
                  className="group flex items-center justify-between gap-3 rounded-lg px-2 py-1.5 motion-press hover:bg-muted/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  aria-label={`View ${slice.value} ${slice.label.toLowerCase()} clients`}
                >
