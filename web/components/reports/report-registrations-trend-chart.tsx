...
import type { ReportTrendPoint } from "@/lib/reports-api";

const REGISTRATIONS_COLOR = "var(--chart-1)";
const NEW_CLIENTS_COLOR = "var(--chart-4)";

type ReportRegistrationsTrendChartProps = {
...
export function ReportRegistrationsTrendChart({
  points,
  periodLabel,
}: ReportRegistrationsTrendChartProps) {
  ...
  return (
    <DashboardChartCard
      headingId="report-registrations-trend-heading"
      title="Registrations over time"
      description={`Daily sign-ups for ${periodLabel} (UTC).`}
      headerAside={
