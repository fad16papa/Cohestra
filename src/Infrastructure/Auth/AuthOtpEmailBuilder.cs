...
public static class AuthOtpEmailBuilder
{
                ...
                <tr><td align="center">
                  <table role="presentation" width="100%" style="max-width:480px;background:#ffffff;border:1px solid #e8e4df;border-radius:16px;overflow:hidden;">
                    <tr><td style="padding:28px 28px 8px;">
                      <p style="margin:0;font-size:12px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:#40916c;">{BrandName}</p>
    ...
    {
        var subject = "Reset your Cohestra password";
        var plainText = new StringBuilder()
            .AppendLine(BrandName)
            .AppendLine()
