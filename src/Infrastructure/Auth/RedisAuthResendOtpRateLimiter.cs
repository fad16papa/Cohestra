...
public sealed class RedisAuthResendOtpRateLimiter(
    IConnectionMultiplexer redis,
    IOptions<AuthResendOtpRateLimitOptions> options) : IAuthResendOtpRateLimiter
{
    private const string LimiterName = "AuthResendOtp";
    ...
    private static RedisKey BuildEmailKey(string email)
    {
        ...
        return (RedisKey)$"auth:otp:resend:email:{hash}";
    }
    ...
    private static RedisKey BuildIpKey(string clientIdentifier)
    {
        ...
        return (RedisKey)$"auth:otp:resend:ip:{hash}";
    }
