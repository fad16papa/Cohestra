...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260831134650_AddCommunityDefaultAndTemplatePresetPin")]
    partial class AddCommunityDefaultAndTemplatePresetPin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cohestra.Domain.Activities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cohestra.Domain.Campaigns.CampaignAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cohestra.Domain.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cohestra.Domain.Site.SiteHomepageTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("site_homepage_templates", "public");
                });

            modelBuilder.Entity("Cohestra.Domain.Site.SitePage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("DraftSections")
                        .HasColumnType("jsonb")
                        .HasColumnName("draft_sections_json");

                    b.Property<DateTimeOffset>("DraftUpdatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("PreviousPublishedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("PreviousPublishedSections")
                        .HasColumnType("jsonb")
                    ...
                    b.Property<string>("PublishedSections")
                        .HasColumnType("jsonb")
                    ...
                    b.ToTable("site_pages", "public");
                });

            modelBuilder.Entity("Cohestra.Domain.Support.SupportIssue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "SubmittedByUserId", "CreatedAt");

                    b.ToTable("support_issues", "public");
                });

            modelBuilder.Entity("Cohestra.Domain.Support.SupportIssueAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("SupportIssueId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("SupportIssueId");

                    b.ToTable("support_issue_attachments", "public");
                });

            modelBuilder.Entity("Cohestra.Domain.Support.SupportIssueReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("support_issue_replies", "public");
                });

            modelBuilder.Entity("Cohestra.Domain.Tenants.PlatformAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("platform_audit_logs", "public");
                });

            modelBuilder.Entity("Cohestra.Domain.Tenants.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cohestra.Domain.Tenants.TenantInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cohestra.Domain.Tenants.TenantMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("tenant_memberships", "public");
                });
            ...
            modelBuilder.Entity("Cohestra.Domain.Support.SupportIssueAttachment", b =>
                {
                    b.HasOne("Cohestra.Domain.Support.SupportIssue", "SupportIssue")
                        .WithMany("Attachments")
                        .HasForeignKey("SupportIssueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SupportIssue");
                });
