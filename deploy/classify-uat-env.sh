...
row "WEB_HOST_PORT" "FREEZE UAT" "${WEB_HOST_PORT:-}"
row "API_HOST_PORT" "FREEZE UAT" "${API_HOST_PORT:-}"
row "NGINX_HOST_PORT" "FREEZE UAT" "${NGINX_HOST_PORT:-}"
...
row "NEXT_PUBLIC_RECAPTCHA_TEST_TOKEN" "REMOVE LOCAL-ONLY" "${NEXT_PUBLIC_RECAPTCHA_TEST_TOKEN:-}"
